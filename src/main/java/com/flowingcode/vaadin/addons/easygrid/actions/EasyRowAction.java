...
public final class EasyRowAction<T>
  ...
  private final ValueProvider<T, ? extends AbstractIcon<?>> iconProvider;
  ...
  EasyRowAction(RowActionsManager<T> manager,
      ValueProvider<T, String> labelProvider,
      ValueProvider<T, ? extends AbstractIcon<?>> iconProvider,
      SerializableConsumer<T> actionHandler) {
  ...
  EasyRowAction(RowActionsManager<T> manager,
      ...
      ValueProvider<T, ? extends AbstractIcon<?>> iconProvider,
      String eventHandler) {
    this(manager, labelProvider, iconProvider, new ClientSideEventHandler<T>(eventHandler));
  }

  @RequiredArgsConstructor
  private final static class ClientSideEventHandler<T> implements SerializableConsumer<T> {
