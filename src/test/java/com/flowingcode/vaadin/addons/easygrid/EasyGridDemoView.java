...
@CssImport("./styles/easy-grid-demo-styles.css")
public class EasyGridDemoView extends TabbedDemo {

  public EasyGridDemoView() {
    addDemo(AutoColumnsDemo.class);
    addDemo(SelectiveColumnsDemo.class);
    addDemo(TypeRenderingDemo.class);
    addDemo(NumberRenderingDemo.class);
